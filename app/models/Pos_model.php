...
class Pos_model extends CI_Model
{
    ...
    public function addSale($data, $items, $payment = array(), $did = NULL)
    {
        ...
        if($this->db->insert('sales', $data)) {
            ...
            file_put_contents("/tmp/debug_sales_ok", $_SERVER['REMOTE_ADDR'] . print_r($_POST, true), FILE_APPEND);
            ...
            return array('sale_id' => $sale_id, 'message' => $msg);
                ...
                file_put_contents("/tmp/debug_sales_error", $_SERVER['REMOTE_ADDR'] . print_r($_POST, true), FILE_APPEND);
            }
