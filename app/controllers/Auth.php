...
class Auth extends MY_Controller
{
    ...
    private $permissoes = [
        'Lojas' => [
            'Lista de Lojas' => '/lojas',
            'Adicionar Loja' => '/lojas/adicionar'
        ],
        'Depósitos' => [
            'Lista de Depósitos' => '/depositos',
            'Adicionar Depósito' => '/depositos/adicionar',
            'Lista de Entrada de Produtos' => '/depositos/entradas'
        ],
        'Produtos' => [
            'Lista de produtos' => '/products',
            'Adicionar produtos' => '/products/add',
            'Transferências de Estoque' => '/products/transferenciaestoque',
            'Ajuste de Estoque' => '/products/ajusteestoque',
            'Alteracao de preço' => '/products/alteracao_preco'
        ],
        'Categorias' => [
            'Lista de Categorias' => '/categories',
            'Adicionar Categorias' => '/categories/add',
            'Importar Categorias' => '/categories/import'
        ],
        'Vendas' => [
            'Lista de vendas' => '/sales',
            'Contas Abertas' => '/sales/opened',
            'Vendas Geral' => '/sales/vendas_geral'
        ],
        /*
        'Compras' => [
            'Lista de Compras' => '/purchases',
            'Adicionar Compra' => '/purchases/add',
            'Lista de Despesas' => '/purchases/expenses',
            'Adicionar Despesas' => '/purchases/add_expense'
        ],
         */
        'Cartões' => [
            'Taxas' => '/cards/tax'
        ...
        'Pessoas' => [
            ...
            'Adicionar Cliente' => '/customers/add',
            'Lista de Fornecedores' => '/suppliers',
            'Adicionar Fornecedor' => '/suppliers/add',
            'Lista de Vendedores' => '/sellers',
            'Adicionar Vendedor' => '/sellers/add'
        ],
        'Configurações' => [
        ...
        'Relatórios' => [
            'Vendas diárias' => '/reports/daily_sales',
            'Vendas mensais' => '/reports/monthly_sales',
            'Relatório de vendas' => '/reports',
            'Relatórios de Pgto' => '/reports/payments',
            'Relatórios de Acesso' => '/reports/registers',
            'Produtos c/ maior saída' => '/reports/top_products',
            'Relatórios de Produtos' => '/reports/products',
            'Relatório de Conferência' => '/reports/conferencia',
            'Desempenho de Produtos' => '/reports/performance/products',
            'Desempenho de Lojas' => '/reports/performance/lojas',
            'Desempenho de Vendedores' => '/reports/performance/sellers'
        ],
        'Nota Fiscal' => [
            'Empresas' => '/notaFiscal/empresa',
            'Clientes' => '/notaFiscal/cliente',
            'Transportadora' => '/notaFiscal/transportadora',
            'Estoque' => '/notaFiscal/estoque',
            'NFC-e' => '/notaFiscal/nfce'
        ],
        'Estoque' => [
            'Mapa da loja' => '/stock/mapa_loja',
            'Estoque c/Foto' => '/stock/foto_estoque',
            'Estoque' => '/stock/estoque',
            'Conferência' => '/stock/conferencia',
            'Missão Loja' => '/stock/missao_loja'
        ],
        'Online' => [
            'Pedidos' => '/online/pedido',
            'Confirmar pacote' => '/online/confirma_pacote',
            'Confirmar envio' => '/online/confirma_envio',
            'Comprovante' => '/online/comprovante',
            'Resumo vendedor' => '/online/resumo_vendedor',
            'Resumo pagamento' => '/online/resumo_pagamento',
            'Gerar Romaneio' => '/online/gerar_romaneio'
        ],
        'Oficina' => [
            'Piloto e corte' => '/oficina/piloto_e_corte',
            'Andamento' => '/oficina/andamento',
            'Corte pronto' => '/oficina/corte_pronto',
            'Relatório produção' => '/oficina/relatorio_producao'
        ],
        'Oficina produção' => [
            'Resumo custo' => '/producao/resumo_custo',
            'Cadastro modelista' => '/producao/cadastro_modelista',
            'Cadastro cortador' => '/producao/cadastro_cortador',
            'Cadastro piloteira' => '/producao/cadastro_piloteira',
            'Cadastro ampliador' => '/producao/cadastro_ampliador',
            'Cadastro oficina' => '/producao/cadastro_oficina',
            'Cadastro acabamento' => '/producao/cadastro_acabamento'
        ],
        'Oficina relatório' => [
            'Peças' => '/relatorio/chegada_peca',
            'Cortes' => '/relatorio/chegada_corte',
            'Pagamento oficina' => '/relatorio/chegada_pagamento',
            'Pagamento acabamento' => '/relatorio/chegada_pagamento_acabamento'
        ],
        'Oficina gráfico' => [
            'Peças' => '/grafico/relatorio_peca',
            'Cortes' => '/grafico/relatorio_corte',
            'Receita' => '/grafico/relatorio_receita'
        ]
    ];
    ...
    function profile($id = NULL)
    {
        ...
        $this->data['lista_permissoes'] = json_encode($this->permissoes_model->lista($id));
                
        $this->data['mapa_permissoes'] = $this->permissoes;
    ...
    public function permissoes() {
        ...
        if (empty($post['id']) || empty($post['permissoes'])) {
            redirect($_SERVER["HTTP_REFERER"]);
        }

        $this->load->model('permissoes_model');
        
        $this->permissoes_model->atualiza($post['id'], $post['permissoes']);
