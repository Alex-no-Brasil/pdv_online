                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <?= lang("name", "name") ?>
                                    <?= form_input('name', set_value('name', $product->name), 'class="form-control" id="name"'); ?>
                                </div>
                                <div class="form-group">
                                    <?= lang("code", "code") ?>
                                    <?= form_input('code', set_value('code', $product->code), 'class="form-control tip" id="code"  required="required"'); ?>
                                </div>
                                <div class="form-group">
                                    <?= lang("EAN", "EAN") ?>
                                    <?= form_input('ean', set_value('ean', $product->ean), 'class="form-control tip" id="ean"  required="required"'); ?>
                                </div>
                                
                                <div class="form-group">
                                    <label>NCM</label>
                                    <?= form_input('ncm', $product->ncm, 'class="form-control tip" id="ncm" maxlength="10" required="required"'); ?>
                                </div>
