                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <?= lang("name", "name") ?>
                                    <?= form_input('name', set_value('name'), 'class="form-control" id="name" required'); ?>
                                </div>
                                <div class="form-group">
                                    <?= lang("code", "code") ?>
                                ...
                                <div class="form-group">
                                    <?= lang("EAN", "EAN") ?>
                                    <?= form_input('ean', set_value('ean'), 'class="form-control tip" id="ean"  required="required"'); ?>
                                </div>
                               
                                <div class="form-group">
                                    <label>NCM</label>
                                    <?= form_input('ncm', set_value('ncm'), 'class="form-control tip" id="ncm" maxlength="10" required="required"'); ?>
                                </div>
...
<div class="form-group">
                                ...
                                <?= form_input('product_tax', set_value('product_tax', 0), 'class="form-control tip" id="product_tax"  "'); ?>
</div>
<div class="form-group">
                                <?= lang('tax_method', 'tax_method'); ?>
                                <?php $tm = array(0 => lang('inclusive'), 1 => lang('exclusive')); ?>
                                <?= form_dropdown('tax_method', $tm, set_value('tax_method'), 'class="form-control tip select2" id="tax_method"  style="width:100%;"'); ?>
</div>
...
<script src="<?= $assets ?>dist/js/jquery-ui.min.js" type="text/javascript">
</script>
