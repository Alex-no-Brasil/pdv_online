...
<script>
    ...
    function dt_actions(dados, type, row) {
        ...
        var actions = '<a href="#" title="Imprimir romaneio" class="tip btn btn-primary btn-xs" onclick="imprimir(' + id + ')">\n\
    ...
    function imprimir(id) {
        window.open("imprimir_romaneio_tel/" + id);
    }
    ...
    $(document).ready(function () {
        ...
        dataTable = $('#table_online').DataTable({
            ...
            'bProcessing': true,
            'bServerSide': true,
            'sAjaxSource': '<?= site_url('online/get_pedidos_romaneio') ?>',
