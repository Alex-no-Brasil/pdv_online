        ...
        <div class="col-lg-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a data-toggle="tab" href="#edit_profile"><?= lang('edit'); ?></a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#cpassword"><?= lang('change_password'); ?></a>
                    </li>
                    <?php if($Admin) : ?>
                        <li>
                ...
                <div class="tab-content">
                    ...
                    <?php if($Admin) : ?>
                        <div id="permissoes" class="tab-pane">
                            <div class="col-lg-6">
                                <div class="white-panel">
                                    <?php echo form_open("auth/permissoes"); ?>
                                    <table class="table">
                                        <tr>
                                            <td width="10">
                                                <input type="checkbox" name="permissoes[]" value="/">
                                            </td>
                                            <td>
                                                <strong>Dashboard</strong>
                                            </td>
                                        </tr>
                                        <?php foreach ($mapa_permissoes as $nome => $rotas) : ?>
                                            <tr>
                                                <td colspan="2" align="left">
                                                    <strong><?= $nome ?></strong>
                                                </td>
                                            </tr>
                                            <?php foreach ($rotas as $rota_nome => $url) : ?>
                                                <tr>
                                                    <td width="10">
                                                        <input type="checkbox" name="permissoes[]" value="<?= $url ?>">
                                                    </td>
                                                    <td>
                                                        <?= $rota_nome ?>
                                                    </td>
...
<?php if($Admin) : ?>
<script>
var lista_permissoes = <?=$lista_permissoes?>;

$.each(lista_permissoes, function (i, e) {
    $('input[value="' + e.rota + '"]').prop('checked', true);
});
</script>
<?php endif; ?>