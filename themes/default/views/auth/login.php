...
<body background="themes/default/assets/images/background.jpg">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?=base_url();?>"><?= $Settings->site_name == 'PDV' ? '<b>PDV</b>' : '<img src="'.base_url('uploads/'.$Settings->logo).'" alt="'.$Settings->site_name.'" height="200" width="200"/>'; ?></a>
        </div>
        <div class="login-box-body">
            <p>&nbsp;</p>
            
            <div style="text-align: center;">SEJA BEM VINDO !</div> 
            <p>&nbsp;</p>
                        <?php if($error)  { ?>
