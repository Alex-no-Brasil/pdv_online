            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div class="table-responsive">                        
                        <table id="table_transportadora" class="table table-striped table-bordered table-condensed table-hover">
                            <thead>
                                <tr class="active">
                                    <th>Razão Social</th>                                    
                                    <th>CNPJ</th>
...
<script>
    ...
    function openMdlNovo(id) {
        ...
        var url = 'modal_cadastro_transportadora';
...
<?php if ($Admin) : ?>
    <script>
        function excluir(id) {
            ...
            $.post('transportadora_excluir', post, function (resp) {
